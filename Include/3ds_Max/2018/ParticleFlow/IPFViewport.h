...
public:
	...
	\param generateRenderItemsContext context for generated render items
	\param updateDisplayContext The display context, which contains all the requirements for 
								the plugin to generate render items.
	\param nodeContext  Contains all information required for adding per node
						relevant render items.
	\param targetRenderItemContainer - The target render item container to which this plugin object
						will be added.
