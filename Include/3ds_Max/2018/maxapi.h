...
public:
	...
	*/
	...
	true even when not in non interactive mode. This is used for testing the disabling of functionality
	via the -headless command line options
	\return True if in non interactive mode.
	\see SetInNonInteractiveMode()
