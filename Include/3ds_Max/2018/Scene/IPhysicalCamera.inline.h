...
inline Class_ID IPhysicalCamera::GetClassID()
{
    return Class_ID(0x46697218, 0x28e8008d);
}

//==================================================================================================
// class IPhysicalCamera::IPhysicalCameraToneOperator
//

inline Class_ID IPhysicalCameraToneOperator::GetClassID()
{
    return Class_ID(0x27964a9b, 0x2ea5376a);
}
