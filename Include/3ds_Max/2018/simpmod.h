...
public:
		...
		//! \deprecated Use SimpleModClone(SimpleMod *smodSource, RemapDir& remap )
		MAX_DEPRECATED void SimpleModClone(SimpleMod *smodSource);
...
public:
		...
		*/
		...
		//! \deprecated Use SimpleWSMModClone(SimpleMod *smodSource, RemapDir& remap )
		MAX_DEPRECATED void SimpleWSMModClone(SimpleWSMMod *smodSource);
...
public:
		...
		//! \deprecated Use SimpleWSMModClone(SimpleMod *smodSource, RemapDir& remap )
		MAX_DEPRECATED void SimpleWSMModClone(SimpleWSMMod2 *smodSource);
