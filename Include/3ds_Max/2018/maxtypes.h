...
public:
	...
	*/
	...
	bool operator==(const Class_ID& cid) const { return ((a == cid.a) && (b == cid.b)); }
	/*! \remarks Check for Inequality between two Class IDs. */
	bool operator!=(const Class_ID& cid) const { return !operator==(cid); }
...
public:
	...
	<b>const Interface_ID\& iid</b>\n\n
	The ID to check. */
	bool operator==(const Interface_ID& iid) const { return ((a == iid.a) && (b == iid.b)); }
	...
	<b>const Interface_ID\& iid</b>\n\n
	The ID to check. */
	bool operator!=(const Interface_ID& iid) const { return !operator==(iid); }
