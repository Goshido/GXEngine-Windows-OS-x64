...
a pre-calculated solution), as well as image based solvers (which calculate
...
public:
	...
	*/
	...
	\param recalcSolution - Indicates whether the solution will be re-calculated (ie, there is a glowing object
		that will create the solution).
