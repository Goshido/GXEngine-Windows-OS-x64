...
/*! \sa Class IMtlRender_Compatibility_Renderer, Class ClassDesc2, Class Mtl, Class Texmap
   ...
   \par Implementation:
   To be inherited by a ClassDesc or ClassDesc2 of a Texmap or Mtl plugin.
   ...
   be used to provide an Enabled/Disabled color. In mental ray enabled uses a yellow 
...
/*! \sa IMtlRender_Compatibility_MtlBase, Class ClassDesc2, Class Mtl, Class Texmap
	...
	To be inherited by a ClassDesc or ClassDesc2 of a Renderer plugin.
	The child class needs to call Init(*this) in its constructor.
...
public:
	...
	/*! \remarks Returns whether this material/map is compatible with the given renderer.
		...
		\return true if this renderer is compatible with the given material */
...
/*!
	...
	Renderer plugin. Always use this function to determine compatibility.
*/
